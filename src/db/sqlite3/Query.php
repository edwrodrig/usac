...
function register_remembered_login($id_login, $token_hash, $id_user, $id_session, $expiration) {
  $query = <<<'SQL_STMT'
INSERT INTO usac_remembered_logins (id_login, token_hash, id_user, id_session, expiration) VALUES (:id_login, :token_hash, :id_user, :id_session, :expiration)
SQL_STMT;

  $s = $this->pdo->prepare($query);

  $s->bindValue(':id_login', $id_login);
  $s->bindValue(':token_hash', $token_hash);
  $s->bindValue(':id_user', $id_user);
...
function close_remembered_login_by_id_login($id_login) {
  $query = <<<'SQL_STMT'
DELETE FROM usac_remembered_logins WHERE id_login = :id_login
SQL_STMT;
...
function update_remembered_login_by_id_login($token_hash, $id_session, $expiration, $id_login) {
  $query = <<<'SQL_STMT'
UPDATE usac_remembered_logins SET token_hash = :token_hash, id_session = :id_session, expiration = :expiration WHERE id_login = :id_login
SQL_STMT;
...
function get_remembered_login_by_id_login($id_login) {
  $query = <<<'SQL_STMT'
SELECT id_login, token_hash, id_user, id_session, expiration FROM usac_remembered_logins WHERE id_login = :id_login
SQL_STMT;
...
function get_user_by_id_user($id_user) {
  $query = <<<'SQL_STMT'
SELECT id_user, name, password_hash, mail FROM usac_users WHERE id_user = :id_user
SQL_STMT;
